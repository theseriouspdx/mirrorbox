...
| 1.1-H32 | mbo setup source detection — walk project, identify scan roots by heuristic, prompt user to confirm, write scanRoots to .mbo/config.json; scanner reads config with src/ fallback; reinstall on johnseriouscom and MBO_Alpha | OPEN |

...
|---|---|---|---|---|---|---|---|---|
| v0.11.87 | audit | Live UX Workflow Audit (Human-Driven) | COMPLETED | claude | master | 2026-03-17 | UX-022..028,Section-36 | Section 36 authored and merged to SPEC.md; chat-native contract fully specified |
| v0.11.86 | bug | BUG-086 root-mismatch re-onboarding validation round 2 | COMPLETED | gemini | gemini/bug-086-revalidate | 2026-03-17 | BUG-086 | Fresh install re-onboards when copied profile has missing/foreign `projectRoot`; verified with `scripts/test-onboarding.js` |

...
async function routeModels(classification = {}, blastRadius = []) {
  ...
  if (opConfig) {
    ...
    // BUG-143 shim (DEPRECATED as of v0.13.02): alias 'planner' key → architecturePlanner + componentPlanner.
    // setup.js now writes both keys explicitly. This shim remains for configs written before v0.13.02.
